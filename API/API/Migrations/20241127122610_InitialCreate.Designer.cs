...
namespace API.Migrations
{
    ...
    [Migration("20241127122610_InitialCreate")]
            ...
            modelBuilder.Entity("API.Models.Categoria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CriadoEm = new DateTime(2024, 11, 28, 9, 26, 10, 363, DateTimeKind.Local).AddTicks(6412),
                            Nome = "Trabalho"
                        },
                        new
                        {
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 11, 29, 9, 26, 10, 363, DateTimeKind.Local).AddTicks(6422),
                            Nome = "Estudos"
                        },
                        new
                        {
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 11, 30, 9, 26, 10, 363, DateTimeKind.Local).AddTicks(6425),
                            Nome = "Lazer"
                        });
                });
            ...
            modelBuilder.Entity("API.Models.Tarefa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoriaId = "bfe4e7dc-81e4-4e47-a67b-d4fbf3e124bd",
                            CriadoEm = new DateTime(2024, 12, 4, 9, 26, 10, 363, DateTimeKind.Local).AddTicks(6567),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 11, 30, 9, 26, 10, 363, DateTimeKind.Local).AddTicks(6572),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 12, 11, 9, 26, 10, 363, DateTimeKind.Local).AddTicks(6593),
